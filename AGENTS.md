...
## Overview
This project provides an integration between n8n and the hostedsms.pl system.
n8n is a workflow automation platform where users build workflows with nodes, which are the
...
- https://hostedsms.pl/pl/api-sms/opis-techniczny-api/
